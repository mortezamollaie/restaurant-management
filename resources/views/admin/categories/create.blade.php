                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="file" id="image" name="image"
                                    class="black w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base loading-normail transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('image') border-red-400 @enderror">
                            </div>
                            @error('image')
                                <div class="text-sm text-red-400">
                                    {{ $message }}
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="description" rows="3" name="description"
                                    class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base loading-normail transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('description') border-red-400 @enderror">
                                </textarea>
                            </div>
                            @error('description')
                                <div class="text-sm text-red-400">
